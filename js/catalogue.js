    ...
    */
    ...
    for (i = 0; i < cards.length; i++) {
        ...
        */
        ...
        /*
            Get the first paragraph inside the current card,
            read its text, and convert it to lowercase.
        */
        ...
        */
        var keywordMatches =
            productName.indexOf(keyword) >= 0 ||
            productDescription.indexOf(keyword) >= 0;

        /*
            The category matches when "all" is selected,
            or when the product category equals the chosen category.
        */
        var categoryMatches =
    ...
    /* Show a message if no products remain visible. */
...
function sortCatalogue() {
    ...
    */
    ...
    for (i = 0; i < cardArray.length - 1; i++) {
        ...
        for (j = 0; j < cardArray.length - i - 1; j++) {
            ...
            if (selectedSort === "name-az") {
                ...
                */
                leftValue =
                    parseInt(cardArray[j].getAttribute("data-order"));

                rightValue =
                    parseInt(cardArray[j + 1].getAttribute("data-order"));

                /* Swap when the original order numbers are reversed. */
                if (leftValue > rightValue) {
                    outOfOrder = true;
                }
            }
    ...
    /*
        Move the cards back into the grid using the sorted order.
        appendChild moves existing cards and does not duplicate them.
    */
...
/* Make sure all required catalogue elements exist. */
if (
    searchBox !== null &&
    categoryBox !== null &&
    sortBox !== null &&
